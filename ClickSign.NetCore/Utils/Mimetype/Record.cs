...
internal class Record
{
    ...
    internal Record(string extentions, string hex)
    {
    ...
    internal Record(string extentions, string hex, int offset)
    {
        Offset = offset;
        Extentions = extentions;
        Hex = hex;
    ...
    internal Record(string extentions, string hex, string description)
    {
        Extentions = extentions;
        Hex = hex;
    ...
    /// <param name="description">description</param>
    internal Record(string extentions, string hex, int offset, string description)
    {
        Offset = offset;
        Extentions = extentions;
        Hex = hex;
    ...
    /// </summary>
    internal string Extentions { get; set; }
    ...
    /// </summary>
    internal bool IsComplexMetadata =>
        Offset > 0 || Hex.Contains("?");
}