// <copyright file="MimeTypes.cs" company="Rocket Robin">
...
internal static class MimeTypes
{
    ...
    static MimeTypes()
    {
        MimeTypeDictionary = new Dictionary<string, string>
        {
            { "323", "text/h323" },
            { "3dmf", "x-world/x-3dmf" },
            { "3dm", "x-world/x-3dmf" },
    ...
    /// </exception>
    internal static string GetMimeType(string extention)
    {
        if (extention == null) throw new ArgumentNullException(nameof(extention));

        if (extention.StartsWith(".")) extention = extention.TrimStart('.');

        if (!MimeTypeDictionary.TryGetValue(extention, out var mimeType)) mimeType = "application/octet-stream";
