...
/// <summary>
/// Classe para conversão do enumerador <see cref="DeliveryType" /> para json e vice-versa.
/// </summary>
public class DeliveryTypeConverter : JsonConverter
{
    /// <summary>
    ...
    {
        var signType = (DeliveryType)value;
        switch (signType)
        {
